...
// Kingdom (BossRaidWorldHomeStage) grounds it via the Lord of Lightning
// boss-attack state. Both kingdoms also block backtracking until the Odyssey
// is released — unique among SMO kingdoms.
//
